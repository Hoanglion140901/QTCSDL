...
namespace TESTDB
{
    public partial class NhapChiTiet : Form
    {
        ...
        public void load()
        {
            ...
            {
                conn.Open();
                string sql = "select * from  NHAP_CHI_TIET";
        ...
        private void Sửa_Click(object sender, EventArgs e)
        {
            ...
            {
                conn.Open();
                string sql = " update Nhap_Chi_Tiet set soluong='"+txtSL.Text+"',thanhtien='"+txtThanhTien.Text+ "' where maHDN='" + txtMaHDN.Text + "' and mamh='"+txtMaMH.Text+"'";
        ...
        private void Thêm_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (txtMaHDN.Text != "" && txtMaMH.Text != "" && txtSL.Text != "" && txtThanhTien.Text != "")
                {
                    conn.Open();
                    string sql = "insert into NHAP_CHI_TIET values('" + txtMaHDN.Text + "','" + txtMaMH.Text + "','" + txtSL.Text + "','" + txtThanhTien.Text + "')";
        ...
        private void Xóa_Click(object sender, EventArgs e)
        {
            ...
            if (thongbao == DialogResult.OK)
            {
                SqlConnection conn = new SqlConnection(ChuoiKetNoi);
                conn.Open();
                string sql = "delete from NHAP_CHI_TIET where MaHDN='" + txtMaHDN.Text + "' and MAMH='"+txtMaMH.Text+"'";
                SqlCommand cmd = new SqlCommand(sql, conn);
                cmd.ExecuteNonQuery();
